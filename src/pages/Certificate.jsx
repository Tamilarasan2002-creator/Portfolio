        ...
        {[
          {
            ...
            issuer: "Issued by Infosys",
            details: "HTML, CSS, JavaScript",
            color: "rgba(0, 255, 255, 0.8)",
          },
          {
            title: "📜 CyberSecurity",
            issuer: "Issued by Cisco Network Security",
            details: "Introduction to Cyber Security",
            color: "rgba(255, 165, 0, 0.8)",
          },
          {
            title: "📜 GET",
            issuer: "Issued by Government Of Tamil Nadu",
            details:
              "Typewriting English Junior (FIRST CLASS WITH DISTINCTION)",
            color: "rgba(0, 255, 0, 0.8)",
          },
          {
            title: "📜 Project Paper Presentation",
            issuer: "Issued by Kalpataru Institute of Technology",
            details:
